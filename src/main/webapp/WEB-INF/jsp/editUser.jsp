...
<body>
	...
	<div class="column">
		<h1 class="ui image massive header">Promijenite svoje podatke</h1>
		<form:form action="/users/" method="post"
			...
			<div class="field">
				<input type="tel" name="phone" id="telephone"
					placeholder="Broj telefona" disabled>
			</div>
			<div class="field">
				<input type="email" name="email" id="email"
					placeholder="Adresa elektroničke pošte" disabled>
			</div>
			<div class="field">
			...
			<div class="field">
				<input type="text" name="address" id="address"
					placeholder="Adresa stavnovanja" disabled>
			</div>
			<div class="field">
