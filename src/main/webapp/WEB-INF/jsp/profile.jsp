...
<div id="delete-pet-modal" class="ui small basic test modal transition hidden">
    ...
    <div class="content">
        <p>Brisanje ljubimca uzrokovat će otkazivanje svih njegovih rezervacija, neovisno o razini. Jeste li sigurni da
            želite nastaviti?</p>
    </div>
    <div class="actions">
        <div class="ui green basic cancel inverted button">
...
<div id="add-pet-modal" class="ui mini modal">
    ...
    <div class="ui center aligned content">
        <form:form action="${pageContext.request.contextPath}/users/${user.userId}/pets/" method="post"
                   id="add-pet-form" class="ui large form" modelAttribute="user">
            <div class="field">
