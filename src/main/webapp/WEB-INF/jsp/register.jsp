...
<link rel="stylesheet"
	href="https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.0.8/semantic.min.css" />
<script
	src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
<script
	src="https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.0.8/semantic.min.js"></script>
...
<body>
	...
	<div class="column">
		<h1 class="ui image header">Izradite svoj račun</h1>
		<form:form action="${pageContext.request.contextPath}/users/" method="post"
			class="ui large form segment stacked" modelAttribute="user">
